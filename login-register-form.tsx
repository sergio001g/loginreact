...
export default function LoginRegisterForm({
  onSubmit,
  onSocialLogin = () => {
    console.warn('onSocialLogin function not provided');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (twoFactorEnabled) {
        // Aquí iría la lógica para verificar el código de dos factores
            ...
            >
              ...
              <div className="mt-6 space-y-3">
                <Button 
                  variant="outline" 
                  className={cn(
                    "w-full rounded-full transition-all duration-300 flex items-center justify-center overflow-hidden relative",
